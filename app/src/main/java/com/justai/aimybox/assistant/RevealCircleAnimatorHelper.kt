...
class RevealCircleAnimatorHelper {
    ...
    constructor(fragment: KnowYourselfFragment, container: ViewGroup? = null) {
    ...
    companion object {
         ...
         */
        fun create(fragment: KnowYourselfFragment, container: ViewGroup? = null) = RevealCircleAnimatorHelper(fragment, container)
